...
import com.aiis.project.security.appUser.ApplicationUser;
import com.aiis.project.security.appUser.UserAuthentication;
...
public class JwtServiceImpl implements JwtService{
    ...
    public String createJwt(User jwtUser) {
        ...
        String authorities = jwtUser.getRoles()
                .stream()
                .map(Role::getRole)
